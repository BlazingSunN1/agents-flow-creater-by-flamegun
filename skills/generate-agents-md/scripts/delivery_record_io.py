...
RECORD_SCHEMAS = {
    ...
    "automated-review": {"run id", "code version", "code fingerprint", "command manifest fingerprint", "review trigger", "human trigger reference", "scope", "changed files", "review command id", "review command argv sha-256", "review exit code", "review evidence path", "review evidence sha-256", "findings", "rerun command ids", "rerun exit codes", "verdict"},
